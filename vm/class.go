...
OBJ TrIModule_new(vm *struct TrVM, OBJ module, OBJ super) {
...
OBJ TrModule_alias_method(vm *struct TrVM, OBJ self, OBJ new_name, OBJ old_name) {
...
static OBJ TrModule_name(vm *struct TrVM, OBJ self) {
...
OBJ TrClass_superclass(vm *struct TrVM, OBJ self) {
...
OBJ TrMethod_name(vm *struct TrVM, OBJ self) { return TR_CMETHOD(self).name; }
OBJ TrMethod_arity(vm *struct TrVM, OBJ self) { return TR_INT2FIX(TR_CMETHOD(self).arity); }

func TrMethod_dump(vm *TrVM, self OBJ) OBJ {
